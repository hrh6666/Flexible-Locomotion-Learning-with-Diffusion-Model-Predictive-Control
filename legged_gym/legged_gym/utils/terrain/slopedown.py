...
class TerrainSlopeDown:
    ...
    def generate_fractal_noise_2d(xSize=20, ySize=20, xSamples=1600, ySamples=1600, \
        ...
        for _ in range(fractalOctaves):
            noise += amplitude * TerrainSlopeDown.generate_perlin_noise_2d((xSamples, ySamples), (xScale, yScale)) * zScale
    ...
    def curiculum(self):
        for j in range(self.cfg.num_cols):
            for i in range(self.cfg.num_rows):
                ...
                # if True:
                slope_degree=(self.min_height_degree+i/(self.cfg.num_rows-1)*(self.max_height_degree-self.min_height_degree))
